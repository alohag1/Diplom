...
const I18N = {
    ru: {
        ...
        "pageTitle.grading": "Терем ок? — Система оценок",
        ...
        "reports.creativeType": "Тип креатива",
        ...
        "analyze.create.subtitle": "Загрузите изображение и заполните описание, чтобы запустить анализ",
        "analyze.create.sectionImage": "Выбор изображения",
        "analyze.create.tileCatalog": "Выбрать из каталога",
        "analyze.create.tileCatalogHint": "Использовать сохранённое изображение",
        "analyze.create.tileUpload": "Загрузить с компьютера",
        "analyze.create.tileUploadHint": "PNG, JPG, WEBP до 10 МБ",
        "analyze.create.pickImageLabel": "Выберите изображение",
        "analyze.create.ddPlaceholder": "Выберите изображение",
        "analyze.create.uploadActionLabel": "Файл на устройстве",
        "analyze.create.uploadPreviewEmpty": "Изображение появится здесь после выбора файла",
        "analyze.create.pickFileBtn": "Выбрать файл",
        "analyze.create.confirmSubmit": "Подтвердить и запустить анализ",
        "analyze.create.sectionDescription": "Описание для анализа",
        "analyze.create.descHint": "Опишите, что изображено на креативе, его цель, аудиторию, ключевые элементы…",
        "analyze.create.descPlaceholder": "Введите описание…",
        "analyze.create.sectionType": "Тип креатива",
        "analyze.create.typePoster": "Постер",
        "analyze.create.typeWebsite": "Веб-сайт",
        "analyze.create.typeLogo": "Логотип",
        "analyze.create.typeMockup": "Мокап",
        "analyze.create.typeBanner": "Баннер",
        "analyze.create.typeOther": "Другое",
        "analyze.create.examplesSection": "Примеры сравнительного описания",
        "analyze.create.examplesBadge": "Сравните слабую и сильную формулировку",
        "analyze.create.badTitle": "Плохой пример описания",
        "analyze.create.badBubble": "«Классный постер для сериала»",
        "analyze.create.bad1": "Нет контекста: непонятны цель и канал размещения",
        "analyze.create.bad2": "Не названы ключевые визуальные элементы и текст на макете",
        "analyze.create.bad3": "Слишком кратко — модель получает мало признаков для сопоставления с литературой",
        "analyze.create.goodTitle": "Хороший пример описания",
        "analyze.create.goodBubble": "Фэнтези-постер Game of Thrones: в центре Бран с белыми глазами, слева — ворон, справа — белое дерево с красными листьями. Палитра — холодный синий и тёплый золотой закат. Крупная типографика с цитатой шоу, цель — промо стримингового сезона для аудитории 18–45, акцент на мистической атмосфере и узнаваемых символах бренда.",
        "analyze.create.good1": "Указана цель размещения и аудитория",
        "analyze.create.good2": "Есть упор на композицию, палитру и акценты типографики",
        "analyze.create.good3": "Проще сопоставить визуал с задачей при проверке по критериям",
        "analyze.create.precheckTitle": "Проверка понимания системой",
        "analyze.create.precheckColSummary": "Предварительный вывод системы",
        "analyze.create.precheckColConfidence": "Уверенность системы",
        "analyze.create.precheckColRec": "Рекомендация",
        "analyze.create.precheckEmptySummary": "Загрузите изображение или выберите его из каталога — здесь появится краткий предварительный вывод.",
        "analyze.create.precheckEmptyRec": "Сначала укажите изображение, затем добавьте описание задачи, чтобы модель поняла канал показа и цель коммуникации.",
        "analyze.create.precheckSummaryBare": "Изображение получено как визуальный креатив. Дополнительное текстовое описание повысит совпадение с базой экспертных практик.",
        "analyze.create.precheckSummaryRich": "Контекст из описания позволил связать задачу с визуалом для оценки креатива как «{type}».",
        "analyze.create.precheckRecOk": "Модель уверенно понимает креатив и контекст. Можно запускать анализ.",
        "analyze.create.precheckRecAddDesc": "Для более точной RAG-связки с критериями рекомендуем расширить описание: цели, ограничения и каналы.",
        "analyze.create.precheckSummaryGibberish": "Текст описания не похож на осмысленный бриф: укажите цель, канал, аудиторию и ключевые элементы макета.",
        "analyze.create.precheckRecGibberish": "Замените случайный набор символов на содержательное описание по примерам выше — иначе система не сможет связать задачу с критериями.",
        "analyze.create.precheckSummaryVisual": "По пропорциям макета похоже на «{type}». Добавьте описание: что изображено, для какого канала и аудитории.",
        "analyze.create.precheckRecDescribeVisual": "Опишите этот «{type}»: ключевые объекты, палитру, типографику и цель — как в зелёном примере.",
        "analyze.create.precheckSummaryMismatch": "Выбранный тип («{chosen}») не совпадает с макетом и текстом — по изображению это «{detected}».",
        "analyze.create.precheckRecMismatch": "Уточните тип креатива и описание под реальный макет (постер, сайт, лого и т.д.) и перечислите визуальные детали.",
        "analyze.create.submitFootnote": "Запрос будет добавлен в список «Мои запросы»",
        "analyze.create.step1": "Вы загружаете креатив и заполняете описание задачи",
        "analyze.create.step2": "Выполняется RAG-анализ по 4 критериям качества дизайна",
        "analyze.create.step3": "Результаты сохраняются в вашем списке запросов и отчётах",
        "analyze.create.whyDescTitle": "Зачем нужно описание?",
        "analyze.create.whyDescBody": "Описание фиксирует цель выпуска, канал показа и акценты креатива. Это нужно, чтобы оценки и текстовые рекомендации опирались не только на пиксели, но и на маркетинговый контекст для сопоставления с базой литературы.",
        "analyze.create.moreCriteria": "Подробнее о критериях оценки",
        "analyze.create.fileTooLarge": "Файл больше 10 МБ. Выберите другое изображение.",
        "analyze.create.noCatalogImages": "В каталоге пока нет изображений — сначала загрузите макет на страницу «Загрузка изображений».",
        ...
        "analyze.results.contentTitle": "Содержание макета",
        "analyze.results.contentDepicted": "Изображено",
        "analyze.results.contentAuthor": "Описание от автора",
        "analyze.results.creativeTypeLabel": "Тип креатива",
        ...
        "analyze.results.gradingHelp": "Подробнее о критериях",
        "analyze.planOverlay.title": "Доступно на тарифе «{plan}»",
        "analyze.planOverlay.titleShort": "Нужен другой тариф",
        "analyze.planOverlay.description": "Этот раздел недоступен на вашем тарифе. Выберите подходящий план ниже.",
        "analyze.planOverlay.descTitle": "Описание недоступно",
        "analyze.planOverlay.descDescription": "Чтобы увидеть описание макета, перейдите на Базовый тариф.",
        "analyze.planOverlay.recTitle": "Рекомендации недоступны",
        "analyze.planOverlay.descRecommendations": "Персональные советы по улучшению станут доступны на Профессиональном тарифе.",
        "analyze.planOverlay.uploadTitle": "Лимит исчерпан",
        "analyze.planOverlay.exportTitle": "Экспорт недоступен",
        "analyze.planOverlay.concurrentTitle": "Один анализ за раз",
        "analyze.planOverlay.priceFree": "0 ₽ / мес",
        "analyze.planOverlay.priceBasic": "300 ₽ / мес",
        "analyze.planOverlay.pricePro": "800 ₽ / мес",
        "analyze.planOverlay.includes": "При переходе вы получите:",
        "analyze.planOverlay.upgrade": "Перейти на тариф",
        "analyze.planOverlay.uploadLimit": "Вы использовали {limit} анализов в этом месяце. Выберите тариф с большим лимитом.",
        "analyze.planOverlay.exportBlocked": "Формат {format} недоступен на вашем тарифе. Выберите подходящий план ниже.",
        ...
        "criterion.color": "Цвет",
        "criterion.hierarchy": "Иерархия",
        "criterion.composition": "Композиция",

        "analyze.create.sourceAria": "Источник изображения",
        "analyze.create.typeAria": "Тип креатива",
        "analyze.create.precheckAria": "Проверка понимания системой",

        "grading.title": "Система оценок",
        "grading.back": "Назад к результатам",
        "grading.intro": "Насколько легко читать текст на макете: виден ли заголовок, не сливается ли текст с фоном, не слишком ли много разных шрифтов. Если вы не дизайнер — думайте так: «смогу ли я за пару секунд прочитать главное сообщение?». Здесь расшифровка оценок от 0 до 5 по каждому пункту. Чем выше балл, тем лучше макет.",
        "grading.introFallback": "Оценки от 0 до 5: чем выше балл, тем лучше макет по этому пункту.",
        "grading.criterion.typography": "Типографика",
        "grading.criterion.color": "Цветовые решения",
        "grading.criterion.hierarchy": "Визуальная иерархия",
        "grading.criterion.composition": "Композиция",
        "grading.levelTitle.0": "Отсутствует",
        "grading.levelTitle.1": "Критично",
        "grading.levelTitle.2": "Плохо",
        "grading.levelTitle.3": "Удовлетворительно",
        "grading.levelTitle.4": "Хорошо",
        "grading.levelTitle.5": "Отлично",
        "grading.criteriaAria": "Критерии оценки",
        "grading.sourcesToggle": "Источники и база знаний",
        "grading.criterionSources": "Правила из книг",
        "grading.loadError": "Не удалось загрузить шкалу оценок. Попробуйте обновить страницу.",
        ...
        "subs.overlay.free.sub": "Для знакомства с сервисом",
        "subs.overlay.free.f1": "5 загрузок в месяц",
        "subs.overlay.free.f2": "Оценка по всем критериям",
        "subs.overlay.free.f3": "1 анализ одновременно",

        "subs.overlay.basic.sub": "Расширенный анализ и экспорт",
        "subs.overlay.basic.f1": "20 загрузок в месяц",
        "subs.overlay.basic.f2": "Оценка по всем критериям",
        "subs.overlay.basic.f3": "Описание макета",
        "subs.overlay.basic.f4": "Экспорт в PDF",
        "subs.overlay.basic.f5": "Параллельные анализы",

        "subs.overlay.pro.sub": "Все возможности сервиса",
        "subs.overlay.pro.f1": "Без лимита загрузок",
        "subs.overlay.pro.f2": "Описание и рекомендации",
        "subs.overlay.pro.f3": "Экспорт PDF, JSON, TXT",
        "subs.overlay.pro.f4": "Расширенный анализ",
        "subs.overlay.pro.f5": "Параллельные анализы",
    ...
    en: {
        ...
        "pageTitle.grading": "Terem ok? — Grading system",
        ...
        "reports.creativeType": "Creative type",
        ...
        "analyze.create.subtitle": "Upload an image and fill in the description to start analysis",
        "analyze.create.sectionImage": "Image selection",
        "analyze.create.tileCatalog": "Choose from catalog",
        "analyze.create.tileCatalogHint": "Use a saved image",
        "analyze.create.tileUpload": "Upload from device",
        "analyze.create.tileUploadHint": "PNG, JPG, WebP up to 10 MB",
        "analyze.create.pickImageLabel": "Choose image",
        "analyze.create.ddPlaceholder": "Select an image",
        "analyze.create.uploadActionLabel": "File from device",
        "analyze.create.uploadPreviewEmpty": "The image will appear here after you choose a file",
        "analyze.create.pickFileBtn": "Choose file",
        "analyze.create.confirmSubmit": "Confirm and start analysis",
        "analyze.create.sectionDescription": "Description for analysis",
        "analyze.create.descHint": "Describe what appears on the creative, its audience, placement, headline and key visuals…",
        "analyze.create.descPlaceholder": "Enter a description…",
        "analyze.create.sectionType": "Creative type",
        "analyze.create.typePoster": "Poster",
        "analyze.create.typeWebsite": "Website",
        "analyze.create.typeLogo": "Logo",
        "analyze.create.typeMockup": "Mockup",
        "analyze.create.typeBanner": "Banner",
        "analyze.create.typeOther": "Other",
        "analyze.create.examplesSection": "Comparative description examples",
        "analyze.create.examplesBadge": "Compare weak and strong wording",
        "analyze.create.badTitle": "Weak description example",
        "analyze.create.badBubble": "\"Cool poster for a series\"",
        "analyze.create.bad1": "No context: unclear goal and placement",
        "analyze.create.bad2": "Key visuals and headline are not spelled out",
        "analyze.create.bad3": "Too short — fewer clues for grounding to the playbook",
        "analyze.create.goodTitle": "Strong description example",
        "analyze.create.goodBubble": "Game of Thrones fantasy poster: Bran with white eyes at center, raven on the left, weirwood tree with red leaves on the right. Palette — cool blue and warm golden sunset. Bold quote typography; goal is streaming season promo for audience 18–45, emphasizing mystical mood and brand symbols.",
        "analyze.create.good1": "Placement goal and audience are stated",
        "analyze.create.good2": "Composition, palette, and typography cues are noted",
        "analyze.create.good3": "Easier to relate visual cues to grading criteria",
        "analyze.create.precheckTitle": "System comprehension check",
        "analyze.create.precheckColSummary": "System draft understanding",
        "analyze.create.precheckColConfidence": "Model confidence",
        "analyze.create.precheckColRec": "Recommendation",
        "analyze.create.precheckEmptySummary": "Pick or upload an image — a preliminary summary will appear here.",
        "analyze.create.precheckEmptyRec": "Start with an image, then explain the objective so we can grasp channel and messaging.",
        "analyze.create.precheckSummaryBare": "Image received as a visual creative — add textual context so we can anchor to expert guidance.",
        "analyze.create.precheckSummaryRich": "Your brief lets us align the visuals with grading as «{type}».",
        "analyze.create.precheckRecOk": "The context looks solid; you can start the analysis.",
        "analyze.create.precheckRecAddDesc": "Add more detail around goals or constraints so RAG can match tighter to the playbook.",
        "analyze.create.precheckSummaryGibberish": "This does not read like a real brief — describe goals, channel, audience, and key visual elements.",
        "analyze.create.precheckRecGibberish": "Replace random characters with a meaningful description (see examples above) so we can align the task with grading criteria.",
        "analyze.create.precheckSummaryVisual": "Aspect ratio suggests «{type}». Add what is shown, the channel, and the audience.",
        "analyze.create.precheckRecDescribeVisual": "Describe this «{type}»: key objects, palette, typography, and goal — like the green example.",
        "analyze.create.precheckSummaryMismatch": "Selected type («{chosen}») does not match the layout — this looks like «{detected}».",
        "analyze.create.precheckRecMismatch": "Align the creative type and description with the actual layout and list concrete visual details.",
        "analyze.create.submitFootnote": "The request will appear in “My requests”",
        "analyze.create.step1": "You upload a creative and fill in the task description",
        "analyze.create.step2": "RAG analysis runs across four design quality criteria",
        "analyze.create.step3": "Results are saved to your requests list and reports",
        "analyze.create.whyDescTitle": "Why add a description?",
        "analyze.create.whyDescBody": "Briefs clarify launch goals, channels, and creative emphasis so scores cite marketing context—not only pixels—when aligning with curated references.",
        "analyze.create.moreCriteria": "More about grading criteria",
        "analyze.create.fileTooLarge": "File exceeds 10 MB. Choose another image.",
        "analyze.create.noCatalogImages": "Catalog is empty — upload creatives on the Images page first.",
        ...
        "analyze.results.contentTitle": "Creative content",
        "analyze.results.contentDepicted": "Depicted",
        "analyze.results.contentAuthor": "Author description",
        "analyze.results.creativeTypeLabel": "Creative type",
        ...
        "analyze.results.gradingHelp": "More about criteria",
        "analyze.planOverlay.title": "Available on the «{plan}» plan",
        "analyze.planOverlay.titleShort": "Upgrade required",
        "analyze.planOverlay.description": "This section is not available on your plan. Choose a suitable plan below.",
        "analyze.planOverlay.descTitle": "Description unavailable",
        "analyze.planOverlay.descDescription": "To see the layout description, upgrade to the Basic plan.",
        "analyze.planOverlay.recTitle": "Recommendations unavailable",
        "analyze.planOverlay.descRecommendations": "Personal improvement tips will become available on the Professional plan.",
        "analyze.planOverlay.uploadTitle": "Limit reached",
        "analyze.planOverlay.exportTitle": "Export unavailable",
        "analyze.planOverlay.concurrentTitle": "One analysis at a time",
        "analyze.planOverlay.priceFree": "0 ₽ / mo",
        "analyze.planOverlay.priceBasic": "300 ₽ / mo",
        "analyze.planOverlay.pricePro": "800 ₽ / mo",
        "analyze.planOverlay.includes": "When you upgrade you get:",
        "analyze.planOverlay.upgrade": "View plans",
        "analyze.planOverlay.uploadLimit": "You have used {limit} analyses this month. Choose a plan with a higher limit.",
        "analyze.planOverlay.exportBlocked": "{format} export is not available on your plan. Choose a suitable plan below.",
        ...
        "criterion.hierarchy": "Hierarchy",
        "criterion.composition": "Composition",

        "analyze.create.sourceAria": "Image source",
        "analyze.create.typeAria": "Creative type",
        "analyze.create.precheckAria": "System comprehension check",

        "grading.title": "Grading system",
        "grading.back": "Back to results",
        "grading.intro": "How easy is the text to read on the layout: is the headline visible, does text blend into the background, are there too many different fonts? If you are not a designer, ask yourself: “Can I read the main message in a couple of seconds?” This page explains scores from 0 to 5 for each criterion. The higher the score, the better the layout.",
        "grading.introFallback": "Scores from 0 to 5: a higher score means a better layout on this criterion.",
        "grading.criterion.typography": "Typography",
        "grading.criterion.color": "Color",
        "grading.criterion.hierarchy": "Visual hierarchy",
        "grading.criterion.composition": "Composition",
        "grading.levelTitle.0": "Absent",
        "grading.levelTitle.1": "Critical",
        "grading.levelTitle.2": "Poor",
        "grading.levelTitle.3": "Fair",
        "grading.levelTitle.4": "Good",
        "grading.levelTitle.5": "Excellent",
        "grading.criteriaAria": "Evaluation criteria",
        "grading.sourcesToggle": "Sources and knowledge base",
        "grading.criterionSources": "Rules from books",
        "grading.loadError": "Could not load the grading scale. Try refreshing the page.",
        ...
        "subs.overlay.free.sub": "Get to know the service",
        "subs.overlay.free.f1": "5 uploads per month",
        "subs.overlay.free.f2": "Scoring across all criteria",
        "subs.overlay.free.f3": "1 analysis at a time",

        "subs.overlay.basic.sub": "Extended analysis and export",
        "subs.overlay.basic.f1": "20 uploads per month",
        "subs.overlay.basic.f2": "Scoring across all criteria",
        "subs.overlay.basic.f3": "Layout description",
        "subs.overlay.basic.f4": "PDF export",
        "subs.overlay.basic.f5": "Parallel analyses",

        "subs.overlay.pro.sub": "Full service capabilities",
        "subs.overlay.pro.f1": "Unlimited uploads",
        "subs.overlay.pro.f2": "Description and recommendations",
        "subs.overlay.pro.f3": "PDF, JSON, TXT export",
        "subs.overlay.pro.f4": "Extended analysis",
        "subs.overlay.pro.f5": "Parallel analyses",
